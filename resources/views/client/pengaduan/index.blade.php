                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    @if ($data->status == 0)
                                                        ...
                                                        <!-- Tombol Hapus -->
                                                        <form
                                                            action="{{ route('userpengaduan.destroy', $data->id_pengaduan) }}"
                                                ...
                                                <div class="modal fade" id="modalEditPengaduan{{ $data->id_pengaduan }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                                        <div class="modal-content border-dark">
                                                            ...
                                                            <form
                                                                action="{{ route('userpengaduan.update', $data->id_pengaduan) }}"
                                                                ...
                                                                <div class="modal-body"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select lokasiMethodEdit"
                                                                            ...
                                                                            <option value="alamat"
                                                                                ...
                                                                                Alamat Manual</option>
                                                                            <option value="koordinat"
                                                                                {{ !$data->lokasi && $data->latitude && $data->longitude ? 'selected' : '' }}>
                                                                                Koordinat (Map)</option>
                                                                            <option value="alamat_koordinat"
                                                                                {{ $data->lokasi && $data->latitude && $data->longitude ? 'selected' : '' }}>
                                                                                Alamat dan Koordinat</option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <textarea name="keterangan_kejadian" class="form-control @error('keterangan_kejadian') is-invalid @enderror"
                                                                            rows="5">{{ old('keterangan_kejadian', $data->keterangan_kejadian) }}</textarea>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="file" name="foto_kejadian[]"
                                                                            class="form-control @error('foto_kejadian') is-invalid @enderror @error('foto_kejadian.*') is-invalid @enderror"
                                                                            accept="image/*" multiple>
                                                                        <small class="text-muted">Biarkan kosong jika tidak
                                                                            ingin menambah foto. Maks. 5 gambar.</small>
                                                                        @error('foto_kejadian')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
            ...
            <div class="modal fade" id="modalTambahPengaduan" tabindex="-1" aria-labelledby="modalTambahLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content border-dark">
                        ...
                        <form action="{{ route('userpengaduan.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="lokasiMethod" onchange="toggleLokasiInput()"
                                        ...
                                        <option value="" disabled
                                            {{ old('lokasiMethod') == null ? 'selected' : '' }}>Pilih metode lokasi
                                        </option>
                                        <option value="alamat" {{ old('lokasiMethod') == 'alamat' ? 'selected' : '' }}>
                                            Alamat Manual</option>
                                        <option value="koordinat"
                                            {{ old('lokasiMethod') == 'koordinat' ? 'selected' : '' }}>Koordinat (Map)
                                        </option>
                                        <option value="alamat_koordinat"
                                            {{ old('lokasiMethod') == 'alamat_koordinat' ? 'selected' : '' }}>Alamat dan
                                            Koordinat</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3" id="alamatInput" style="display: none;">
                                    ...
                                    <input type="text" name="lokasi"
                                        class="form-control @error('lokasi') is-invalid @enderror"
                                        placeholder="Contoh: Jl. Soekarno Hatta No. 13" value="{{ old('lokasi') }}">
                                    @error('lokasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div id="koordinatInput" style="display: none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('latitude') is-invalid @enderror"
                                            name="latitude" id="latitude" placeholder="Contoh: -1.234567"
                                            value="{{ old('latitude') }}">
                                        @error('latitude')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="longitude" placeholder="Contoh: 101.234567"
                                            value="{{ old('longitude') }}">
                                        @error('longitude')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="foto-wrapper">
                                        <div class="input-group mb-2">
                                            <input type="file" name="foto_kejadian[]"
                                                class="form-control @error('foto_kejadian.*') is-invalid @enderror"
                                                accept="image/*">
                                            @error('foto_kejadian.*')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="keterangan_kejadian" class="form-control @error('keterangan_kejadian') is-invalid @enderror"
                                        rows="6" required>{{ old('keterangan_kejadian') }}</textarea>
                                    @error('keterangan_kejadian')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
