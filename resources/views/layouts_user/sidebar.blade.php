    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            <li class="dropdown header-profile">
                <a class="nav-link" href="{{ route('dashboard.user') }}" role="button" data-bs-toggle="dropdown">
                    {{-- profile foto --}}
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a href="{{ route('akun.user') }}" class="dropdown-item ai-icon">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('userpengaduan.index') }}" aria-expanded="false">
